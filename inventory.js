class Inventory {
    constructor() {
        ...
        this.blocks = [
            ...
            { id: 3, color: 0x808080, name: "Stone" },
            { id: 4, color: 0xA0522D, name: "Wood" },
            { id: 5, color: 0xD2B48C, name: "Iron" },
            { id: 6, color: 0xFFD700, name: "Gold" },
            { id: 7, color: 0x111111, name: "Bedrock" },
            { id: 8, color: 0xFF0000, name: "TNT" },
            { id: 9, color: 0x0000FF, name: "Water" }
        ];
        this.initUI();
    }
    initUI() {
